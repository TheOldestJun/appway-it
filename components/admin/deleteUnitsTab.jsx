...
import { useGetAllUnitsQuery, useDeleteUnitMutation } from "@/store/services/units"
...
export default function DeleteUnitsTab() {
    ...
    const unitsList = units?.map(unit => <SelectItem key={unit.id} value={unit.id}>{unit.title}</SelectItem>)
